...
public class AuthController {
    ...
    @Operation(summary = "Đăng nhập bằng Google", description = "Đăng nhập hoặc đăng ký tài khoản bằng Google token")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Đăng nhập thành công"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Google token không hợp lệ")
    })
